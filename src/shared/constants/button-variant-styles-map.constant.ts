...
export const buttonVariantStylesMap: Map<ButtonVariant, string> = new Map([
    ...
    [ButtonVariant.SECONDARY, 'bg-surface text-text-primary border-border-strong hover:bg-surface-hover'],
    [
        ButtonVariant.OUTLINE,
        'bg-transparent text-text-primary border-border-strong hover:bg-btn-primary-bg hover:text-btn-primary-text',
    ],
    [ButtonVariant.GHOST, 'bg-transparent text-text-primary border-transparent hover:bg-surface-hover'],
    [
        ButtonVariant.DANGER,
        'bg-accent text-text-inverted border-accent hover:bg-accent-hover hover:text-accent',
    ],
    [ButtonVariant.ICON, 'bg-transparent text-text-muted border-transparent hover:text-text-primary'],
]);
