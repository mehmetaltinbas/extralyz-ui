...
import type { UpdateUserResponse } from 'src/features/user/types/response/update-user.response';
...
export class UserService {
    ...
    static async updateByToken(dto: UpdateUserDto): Promise<UpdateUserResponse> {
        try {
