...
import { DocumentCreateSourceForm } from 'src/features/source/strategies/type/components/create-source-form/DocumentCreateSourceForm';
...
export class DocumentSourceTypeStrategy implements SourceTypeStrategy {
    ...
    buildInitialCreateSourceDto(): CreateSourceDto {
        return { type: SourceType.DOCUMENT, title: '' };
    }
